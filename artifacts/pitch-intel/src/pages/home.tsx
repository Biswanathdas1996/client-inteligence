...
export default function Home() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-[calc(100vh-4rem)] overflow-hidden">
      ...
      <div className={`w-full ${report ? 'lg:w-[400px] xl:w-[450px] shrink-0 border-r border-[#E5E5E5]' : 'lg:w-1/2 max-w-2xl mx-auto'} bg-white overflow-y-auto transition-all duration-500 ease-in-out z-10 shadow-[4px_0_24px_rgba(0,0,0,0.02)] print:hidden`}>
